...
{
    internal class MergeBlockHandler : ICommandHandler<MergeBlockCommand, FastResult<MergeBlockData>>
    {
        ...
        public UniTask<FastResult<MergeBlockData>> ExecuteAsync(MergeBlockCommand command, CancellationToken ct)
        {
            ...
            if (result.IsError(out FastResult<MergeBlockData> fail))
            {
                return fail;
            }
